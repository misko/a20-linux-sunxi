/*
 * drivers/media/video/sunxi_csi/csi0/sunxi_drv_csi.c
 *
...
static struct csi_fmt formats[] = {
	...
	{
		.name     		= "Y8_1X8 RAW Pass-through",
		.csi_if			= CSI_IF_HV8,
		.ccm_fmt		= V4L2_MBUS_FMT_Y8_1X8,
	...
	{
		.name     		= "SGRBG8 RAW Pass-through",
		.csi_if			= CSI_IF_HV8,
		.ccm_fmt		= V4L2_MBUS_FMT_SGRBG8_1X8,

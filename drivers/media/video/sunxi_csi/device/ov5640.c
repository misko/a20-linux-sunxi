/*
 * drivers/media/video/sunxi_csi/device/ov5640.c
 *
...
static struct regval_list sensor_default_regs_a80[] = {
	{{0x31,0x03},0x11},//
	{{0x30,0x08},0x82},//reset
	{{0xff,0xff},0x1e},//delay 30ms
	{{0x30,0x08},0x42},//power down
	{{0x31,0x03},0x03},//
	//{{0x30,0x17},0x00},//disable oe
	//{{0x30,0x18},0x00},//
	...
	//AWB   
	{{0x34,0x06},0x00},  //0x00, // LA      ORG
	{{0x51,0x80},0xff},  //0xff,	// 0xff    0xff
	{{0x51,0x81},0xf2},  //0x50, // 0xf2    0x50               	
	{{0x51,0x82},0x00},  //0x11, // 0x00    0x11              	
	{{0x51,0x83},0x14},  //0x14, // 0x14    0x14             	
	{{0x51,0x84},0x25},  //0x25, // 0x25    0x25             	
	{{0x51,0x85},0x24},  //0x24, // 0x24    0x24             	
	{{0x51,0x86},0x16},  //0x1c, // 0x09    0x1c              	
	{{0x51,0x87},0x16},  //0x18, // 0x09    0x18              	
	{{0x51,0x88},0x16},  //0x18, // 0x09    0x18              	
	{{0x51,0x89},0x6e},  //0x6e, // 0x75    0x6e             	
	{{0x51,0x8a},0x68},  //0x68, // 0x54    0x68             	
	{{0x51,0x8b},0xe0},  //0xa8, // 0xe0    0xa8             	
	{{0x51,0x8c},0xb2},  //0xa8, // 0xb2    0xa8             	
	{{0x51,0x8d},0x42},  //0x3d, // 0x42    0x3d             	
	{{0x51,0x8e},0x3e},  //0x3d, // 0x3d    0x3d             	
	{{0x51,0x8f},0x4c},  //0x54, // 0x56    0x54             	
	{{0x51,0x90},0x56},  //0x54, // 0x46    0x54             	
	{{0x51,0x91},0xf8},  //0xf8, // 0xf8    0xf8             	
	{{0x51,0x92},0x04},  //0x04, // 0x04    0x04              	
	{{0x51,0x93},0x70},  //0x70, // 0x70    0x70             	
	{{0x51,0x94},0xf0},  //0xf0, // 0xf0    0xf0             	
	{{0x51,0x95},0xf0},  //0xf0, // 0xf0    0xf0             	
	{{0x51,0x96},0x03},  //0x03, // 0x03    0x03              	
	{{0x51,0x97},0x01},  //0x01, // 0x01    0x01              	
	{{0x51,0x98},0x04},  //0x05, // 0x04    0x05              	
	{{0x51,0x99},0x12},  //0x7c, // 0x12    0x7c
	{{0x51,0x9a},0x04},  //0x04, // 0x04    0x04
	{{0x51,0x9b},0x00},  //0x00, // 0x00    0x00
	{{0x51,0x9c},0x06},  //0x06, // 0x06    0x06
	{{0x51,0x9d},0x82},  //0x79, // 0x82    0x79
	{{0x51,0x9e},0x38},  //0x38, // 0x38    0x38
	//Color                  // LA      ORG      
	{{0x53,0x81},0x1e},  //0x1e, // 0x1e    0x1e
	{{0x53,0x82},0x5b},  //0x5b, // 0x5b    0x5b
	{{0x53,0x83},0x14},  //0x08, // 0x08    0x08
	{{0x53,0x84},0x05},  //0x0a, // 0x0a    0x05
	{{0x53,0x85},0x77},  //0x7e, // 0x7e    0x72
	{{0x53,0x86},0x7c},  //0x88, // 0x88    0x77
	{{0x53,0x87},0x72},  //0x7c, // 0x7c    0x6d
	{{0x53,0x88},0x58},  //0x6c, // 0x6c    0x4d
	{{0x53,0x89},0x1a},  //0x10, // 0x10    0x20
	{{0x53,0x8a},0x01},  //0x01, // 0x01    0x01
	{{0x53,0x8b},0x98},  //0x98, // 0x98    0x98
	//Sharpness/Denoise     
	{{0x53,0x00},0x08}, 
	{{0x53,0x01},0x30},      
	{{0x53,0x02},0x30}, 
	...
	{{0x54,0x81},0x06},  //0x08,  // 0x08     0x06
	{{0x54,0x82},0x12},  //0x14,  // 0x14     0x15
	{{0x54,0x83},0x1e},  //0x28,  // 0x28     0x28
	{{0x54,0x84},0x4a},  //0x51,  // 0x51     0x3b
	{{0x54,0x85},0x58},  //0x65,  // 0x65     0x50
	{{0x54,0x86},0x65},  //0x71,  // 0x71     0x5d
	{{0x54,0x87},0x72},  //0x7d,  // 0x7d     0x6a
	{{0x54,0x88},0x7d},  //0x87,  // 0x87     0x75
	{{0x54,0x89},0x88},  //0x91,  // 0x91     0x80
	{{0x54,0x8a},0x92},  //0x9a,  // 0x9a     0x8a
	{{0x54,0x8b},0xa3},  //0xaa,  // 0xaa     0x9b
	{{0x54,0x8c},0xb2},  //0xb8,  // 0xb8     0xaa
	{{0x54,0x8d},0xc8},  //0xcd,  // 0xcd     0xc0
	{{0x54,0x8e},0xdd},  //0xdd,  // 0xdd     0xd5
	{{0x54,0x8f},0xf0},  //0xea,  // 0xea     0xe8
	{{0x54,0x90},0x15},  //0x1d,  // 0x1d     0x20
	...
	//  {{0x55,0x88},0x09},
	//Lens Shading 
	{{0x58,0x00},0x15},    //0xa7, //LA        org
	{{0x58,0x01},0x10},    //0x23, //0x23      0x17
	{{0x58,0x02},0x0D},    //0x14, //0x14      0x10
	{{0x58,0x03},0x0D},    //0x0f, //0x0f      0x0e
	{{0x58,0x04},0x0F},    //0x0f, //0x0f      0x0e
	{{0x58,0x05},0x15},    //0x12, //0x12      0x11
	{{0x58,0x06},0x0A},    //0x26, //0x26      0x1b
	{{0x58,0x07},0x07},    //0x0c, //0x0c      0x0b
	{{0x58,0x08},0x05},    //0x08, //0x08      0x07
	{{0x58,0x09},0x05},    //0x05, //0x05      0x05
	{{0x58,0x0A},0x07},    //0x05, //0x05      0x06
	{{0x58,0x0B},0x0B},    //0x08, //0x08      0x09
	{{0x58,0x0C},0x07},    //0x0d, //0x0d      0x0e
	{{0x58,0x0D},0x03},    //0x08, //0x08      0x06
	{{0x58,0x0E},0x01},    //0x03, //0x03      0x02
	{{0x58,0x0F},0x01},    //0x00, //0x00      0x00
	{{0x58,0x10},0x03},    //0x00, //0x00      0x00
	{{0x58,0x11},0x07},    //0x03, //0x03      0x03
	{{0x58,0x12},0x07},    //0x09, //0x09      0x09
	{{0x58,0x13},0x03},    //0x07, //0x07      0x06
	{{0x58,0x14},0x01},    //0x03, //0x03      0x03
	{{0x58,0x15},0x01},    //0x00, //0x00      0x00
	{{0x58,0x16},0x03},    //0x01, //0x01      0x00
	{{0x58,0x17},0x06},    //0x03, //0x03      0x03
	{{0x58,0x18},0x0D},    //0x08, //0x08      0x09
	{{0x58,0x19},0x08},    //0x0d, //0x0d      0x0b
	{{0x58,0x1A},0x06},    //0x08, //0x08      0x08
	{{0x58,0x1B},0x06},    //0x05, //0x05      0x05
	{{0x58,0x1C},0x07},    //0x06, //0x06      0x05
	{{0x58,0x1D},0x0B},    //0x08, //0x08      0x08
	{{0x58,0x1E},0x14},    //0x0e, //0x0e      0x0e
	{{0x58,0x1F},0x13},    //0x29, //0x29      0x18
	{{0x58,0x20},0x0E},    //0x17, //0x17      0x12
	{{0x58,0x21},0x0E},    //0x11, //0x11      0x0f
	{{0x58,0x22},0x12},    //0x11, //0x11      0x0f
	{{0x58,0x23},0x12},    //0x15, //0x15      0x12
	{{0x58,0x24},0x46},    //0x28, //0x28      0x1a
	{{0x58,0x25},0x26},    //0x46, //0x46      0x0a
	{{0x58,0x26},0x06},    //0x26, //0x26      0x0a
	{{0x58,0x27},0x46},    //0x08, //0x08      0x0a
	{{0x58,0x28},0x44},    //0x26, //0x26      0x0a
	{{0x58,0x29},0x26},    //0x64, //0x64      0x46
	{{0x58,0x2A},0x24},    //0x26, //0x26      0x2a
	{{0x58,0x2B},0x42},    //0x24, //0x24      0x24
	{{0x58,0x2C},0x24},    //0x22, //0x22      0x44
	{{0x58,0x2D},0x46},    //0x24, //0x24      0x24
	{{0x58,0x2E},0x24},    //0x24, //0x24      0x28
	{{0x58,0x2F},0x42},    //0x06, //0x06      0x08
	{{0x58,0x30},0x60},    //0x22, //0x22      0x42
	{{0x58,0x31},0x42},    //0x40, //0x40      0x40
	{{0x58,0x32},0x24},    //0x42, //0x42      0x42
	{{0x58,0x33},0x26},    //0x24, //0x24      0x28
	{{0x58,0x34},0x24},    //0x26, //0x26      0x0a
	{{0x58,0x35},0x24},    //0x24, //0x24      0x26
	{{0x58,0x36},0x24},    //0x22, //0x22      0x24
	{{0x58,0x37},0x46},    //0x22, //0x22      0x26
	{{0x58,0x38},0x44},    //0x26, //0x26      0x28
	{{0x58,0x39},0x46},    //0x44, //0x44      0x4a
	{{0x58,0x3A},0x26},    //0x24, //0x24      0x0a
	{{0x58,0x3B},0x48},    //0x26, //0x26      0x0c
	{{0x58,0x3C},0x44},    //0x28, //0x28      0x2a
	{{0x58,0x3D},0xBF},    //0x42, //0x42      0x28
	...
	//  {{0x40,0x05},0x1a},
	//  //power down release
	{{0x50,0x3d},0x00}, //0xd2 square test pattern
	{{0x30,0x08},0x02}, 
	//{REG_TERM,VAL_TERM},
};         
...
{{0x31,0x03},{0x11}},//
	...
	{{0x30,0x08},0x82},//reset //MISKO
	{{0xff,0xff},0x1e},//delay 30ms //MISKO
//{{0x35,0x03},{0x07}}, // MISKO AGC AEC?
//{{0x30,0x08},{0x82}},// this is enabled in the A80 with a 30ms delay right after
{{0x30,0x08},{0x42}},//
{{0x31,0x03},{0x03}},//
//{{0x30,0x17},{0xff}},// A80 00 - disable oe
{{0x30,0x17},{0x00}},// A80 00 - disable oe //MISKO ADDED
//{{0x30,0x18},{0xff}},// A80 00
{{0x30,0x18},{0x00}},// A80 00 // MISKO ADDED
//A80 says pll and clock setting
{{0x30,0x34},{0x1a}},// A80 has 18
{{0x30,0x35},{0x21}},//
{{0x30,0x36},{0x46}},//0x46->30fps
{{0x30,0x37},{0x13}},//////div
	{{0x3c,0x00},{0x04}}, //filtering bands???
	{{0x3c,0x01},{0xb4}},
{{0x31,0x08},{0x01}},//
{{0x36,0x30},{0x36}},//
{{0x36,0x31},{0x0e}},//
...
{{0x36,0x00},{0x08}},//
{{0x36,0x01},{0x33}},//
{{0x30,0x2d},{0x60}},// A80 commented out - System Control Registers Changing these values is not recommended 
{{0x36,0x20},{0x52}},//
{{0x37,0x1b},{0x20}},//
{{0x47,0x1c},{0x50}},//
{{0x3a,0x13},{0x43}},//
...
{{0x3c,0x0a},{0x9c}},//
{{0x3c,0x0b},{0x40}},//
//{{0x38,0x20},{0x41}},// A80 comment - binning
//{{0x38,0x21},{0x07}},// A80 comment - binning
{{0x38,0x14},{0x31}},//
{{0x38,0x15},{0x31}},//
{{0x38,0x00},{0x00}},//
{{0x38,0x01},{0x00}},//
...
{{0x3a,0x00},{0x78}}, // MISKO - ADDED LINE BASED ON A80 // AUTOBANDING ON
...
//dec 06
//{{0x3a,0x02},{0x10}},// - misko
//{{0x3a,0x03},{0xb0}},//  -misko
//previous
...
//dec06 - max 50/60hz step size? as annotated in a80
//{{0x3a,0x0e},{0x03}},//
//{{0x3a,0x0d},{0x04}},//
//original
{{0x3a,0x0e},{0x03}},//
...
{{0x30,0x06},{0xc3}},//
{{0x30,0x0e},{0x58}},//
{{0x30,0x2e},{0x00}},// A80 has this comment out - System Control Registers Changing these values is not recommended

//A80 sets this to 0x42
...
{{0x50,0x00},{0xa7}},//
{{0x50,0x01},{0xa3}},//
//A80 has {0x4740,0x21},//hsync,vsync,clock pol,reference to application note,spec is wrong
	/*
	{{0x51,0x80},{0xff}},
	{{0x51,0x81},{0xf2}},
	{{0x51,0x82},{0x00}},
...
//A80 {0x3406,0x00},  //0x00}, // LA      ORG
	...
	{{0x51,0x84},{0x25}},
	{{0x51,0x85},{0x24}},
	{{0x51,0x86},{0x0f}}, //A80 has 0x16
	{{0x51,0x87},{0x0f}}, //A80 0x16
	{{0x51,0x88},{0x0f}}, //A80 0x16
	{{0x51,0x89},{0x80}}, //A80 0x6e
	{{0x51,0x8a},{0x5d}}, //A80 0x68
	{{0x51,0x8b},{0xe3}}, //A80 0xe0
	{{0x51,0x8c},{0xa7}}, //A80 0xb2
	{{0x51,0x8d},{0x40}}, //A80 0x42
	{{0x51,0x8e},{0x33}}, //A80 0x3e
	{{0x51,0x8f},{0x5e}}, //A80 0x4c
	{{0x51,0x90},{0x4e}}, //A80 0x56
	{{0x51,0x91},{0xf8}}, 
	{{0x51,0x92},{0x04}},
	{{0x51,0x93},{0x70}},
	{{0x51,0x94},{0xf0}},
...
//A80 color
	...
	{{0x53,0x8a},{0x01}},
	{{0x53,0x8b},{0x98}},
//A80 sharpness/denooise
	{{0x53,0x00},{0x08}},
	{{0x53,0x01},{0x30}},
	{{0x53,0x02},{0x10}}, //A80 0x30
	//{{0x53,0x02},{0x30}}, //A80 0x30 //MISKO ADDED 
	{{0x53,0x03},{0x00}}, //A80 0x10
	//{{0x53,0x03},{0x10}}, //A80 0x10 //MISKO ADDED
//A80 has {0x5308,0x25}, //sharpness/noise auto
	{{0x53,0x08},{0x25}}, //MISKO ADDED - default value sould be 0x25 
	{{0x53,0x04},{0x08}}, 
	{{0x53,0x05},{0x30}},
	{{0x53,0x06},{0x08}}, //A80 1c
	//{{0x53,0x06},{0x1c}}, //A80 1c //MISKO ADDED
	{{0x53,0x07},{0x16}}, //A80 2c
	//{{0x53,0x07},{0x2c}}, //A80 2c //MISKO ADDED
	{{0x53,0x09},{0x08}}, 
	{{0x53,0x0a},{0x30}},
	{{0x53,0x0b},{0x04}},
	{{0x53,0x0c},{0x06}},
...
static struct regval_list sensor_ev_neg4_regs[] = {
	{{0x3a,0x0f},{0x10}},	//-1.7EV //control high
	{{0x3a,0x10},{0x08}}, // control low
	{{0x3a,0x1b},{0x10}}, //stable high
	{{0x3a,0x1e},{0x08}}, //stable low
	{{0x3a,0x11},{0x20}}, //fast high
	{{0x3a,0x1f},{0x10}},  //fast low
};
...
static struct regval_list sensor_ev_zero_regs[] = {
	{{0x3a,0x0f},{0x38}},		//default //control high
	{{0x3a,0x10},{0x30}}, 
	{{0x3a,0x1b},{0x38}},
	{{0x3a,0x1e},{0x30}}, 
	{{0x3a,0x11},{0x61}}, 
             ...
             struct v4l2_mbus_framefmt *fmt)//linux-3.0
{
	...
	csi_dev_dbg("sensor_s_fmt\n");
			csi_dev_print("disalbe oe!\n"); //MISKO
			ret = sensor_write_array(sd, sensor_oe_disable_regs , ARRAY_SIZE(sensor_oe_disable_regs)); //MISKO
			if(ret < 0) //MISKO
				csi_dev_err("disalbe oe falied!\n");
